...
def calculation(*numbers):
    ...
    print(list) 
    calculation_operation = (input("What operation would you like me to perform with you're numbers? We can do sum, average, product, max or min: "))
    ...
    elif calculation_operation == "average":
        averagation= sum(numbers) / len (numbers)
        print(f"The average of those numbers is {averagation}!")
