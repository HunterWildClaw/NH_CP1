...
print(f"The captain gets {one_share * 7}$\n The first mate guy gets a whopping {one_share * 3}$\n Each indivual crew member also needs to recieve {one_share-500}$ even after accepting their 500$ dollars.")
